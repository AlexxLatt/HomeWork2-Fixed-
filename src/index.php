    ...
    <div class="container">
        <header class="header">
            ...
            <div class="header__contacts">
                ...
                <a class="header__phone" href="tel:+74999228974">
                   +7 (499) 922-89-74
                </a>
                ...
                <div class="wr-btn">
                    <button data-modal="consultation"><span>заказать звонок</span></button>
                </div>
        ...
        <div class="promo__wrapper">
            ...
            <div class="promo__icons">
                <div class="promo__icon">
                    ...
                    <img src="icons/019_timer_time_stopwatch_2-64.png" alt="timer-icon">
                    Время подбора: 10 минут

                </div>
                <div class="promo__icon">

                    <img src="icons/app 08 hand cart 64.png" alt="hand-cart">
                    Бесплатная доставка
                
                </div>
                <div class="promo__icon">
                    
                    <img src="icons/messages 64.png" alt="messages">
                    Ответим на все вопросы
                
                </div>
            </div>

            <div class="wr-btn wr-btn-main">
                <button data-modal="consultation"><span>заказать кОНСУЛЬТАЦИЮ</span></button>
            </div>
    ...
    <div class="container">
        ...
        <div class="advantages__icons">
            ...
            <div class="advantages__icon">
                ...
                <span>Заботимся о здоровье</span>
...
<section class="consultation">
    <div class="container">
        ...
        <form id="consultation-form" class="feed-form feed-form_mt25" action="check.php" method="post">   
            ...
            <div class="wr-btn wr-btn-main-two">
                <button><span>заказать кОНСУЛЬТАЦИЮ</span></button>
            </div>
...
<section class="carousel">
    <div class="container">
        ...
        <div class="carousel__iner">
            <div><img src="img/slide_1.jpg" alt="slide"></div>
            <div><img src="img/slide_2.jpg" alt="slide"></div>
            <div><img src="img/slide_3.jpg" alt="slide"></div>
            ...
            <div class="catalog-item">
                <div class="catalog-item__wrapper">
                    <div class="catalog-item__content catalog-item__content_active">
                        ...
                        <div class="catalog-item__descr">Пульсометр начального уровня с комфортным тканевым ремешком
                        </div>
                        <a href="#" class="catalog-item__link">ПОДРОБНЕЕ</a>
                    </div>
                    <ul class="catalog-item__list">
            ...
            <div class="catalog-item">
                <div class="catalog-item__wrapper">
                    <div class="catalog-item__content catalog-item__content_active">
                        ...
                        <div class="catalog-item__descr">Улучшенная версия Polar FT1, имеющая следующие улучшения:
                        </div>
                        <a href="#" class="catalog-item__link">ПОДРОБНЕЕ</a>
                    </div>
                    <ul class="catalog-item__list">
...
<section class="reviews">
    <div class="container ">
        ...
        <div class="reviews__indent">
            <div class="reviews-wrapper">
                <div class="reviews-wrapper__img"><img src="img/feed_1.png" alt="IMG"></div>
                <div class="reviews-wrapper__text">
                    <div class="reviews-wrapper__header">Ирина Иванченко </div>
                    <div class="reviews-wrapper__subheader">2 полумарафона</div>
                    <div class="reviews-wrapper__mainReviews">Не знала, что себе купить - обратилась к ребятам из RunSmart - подобрали пульсометр,<br> который подошёл именно под мои цели и финансовые возможности.Через некоторое время решила обновить гаджет - не раздумывая обратилась туда же.Новые цели - новый гаджет! Спасибо, RunSmart!</div>
                </div>
            </div>
            <div class="reviews-wrapper">
                <div class="reviews-wrapper__img"><img src="img/feed_2.png" alt="IMG"></div>
                <div class="reviews-wrapper__text">
                    <div class="reviews-wrapper__header">Иван Сёмочкин </div>
                    <div class="reviews-wrapper__subheader">1 полумарафон</div>
                    <div class="reviews-wrapper__mainReviews">Крутая штука-пульсометр. Обычно без них бегал. Оказывается только хуже себе делал. Купил пульсометр, ещё в подарок получил тренировку. Со мной вместе провели первую тренировку, научили пользоваться новым гаджетом. Также объяснили основы анатомии, составили план тренировок на месяц вперёд.С ними подготовился к своему первому полумарафону! Спасибо!!!</div>
                </div>
            </div>
            <div class="reviews-wrapper">
                <div class="reviews-wrapper__img"><img src="img/feed_3.png" alt="IMG"></div>
                <div class="reviews-wrapper__text">
                    <div class="reviews-wrapper__header">Юлия Дашкина </div>
                    <div class="reviews-wrapper__subheader">2 полумарафона</div>
                    <div class="reviews-wrapper__mainReviews">Долго не могла начать бегать, т.к. до этого несколько раз начинала, но становилось тяжело и я бросала. От друзей услышала о RunSmart и о беге с контролем пульса и решила попробовать.Позвонила, ребята поинтересовались моими целями и подобрали очень интересный вариант со скидкой! Теперь бегаю и наслаждаюсь бегом! Пробежала уже 2 полумарафона и несколько более коротких забегов и не намерена останавливаться!Спасибо!!!</div>
                </div>
            </div>
        </div>
    </div>
...
<footer class="footer">
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2244.4892049728155!2d37.64480094894881!3d55.76737497813294!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46b54a636edcd2ad%3A0x4c2ca101e2c8c617!2z0JzRj9GB0L3QuNGG0LrQuNC5INC_0YAt0LQsIDQvMywg0JzQvtGB0LrQstCwLCAxMDcwNzg!5e0!3m2!1sru!2sru!4v1688307468948!5m2!1sru!2sru" width="100%" height="630" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    <div class="footer__info">
        <address class="footer__adr">Москва, Мясницкий проезд, д.3с1</address>
        <a class="footer__phone" href="tel:84999228974">8 (499) 922-89-74</a>
        <div class="footer__social">
            <a href="https://www.facebook.com/" class="footer__social-item"><img src="icons/facebook.png" alt="facebook"></a>
            <a href="https://instagram.com/" class="footer__social-item"><img src="icons/instagram.png" alt="instagram"></a>
            <a href="https://ru.pinterest.com/" class="footer__social-item"><img src="icons/pinterest.png" alt="pinterest"></a>
        </div>
    </div>
</footer>
